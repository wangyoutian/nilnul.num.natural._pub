...
namespace nilnul.num.natural.prime.conn
{
	 ...
	 public partial class Conn
	{
		...
		public  db.nilnul3Entities db = Db.CreateConnection();
		 ...
		 public bool Contains(long i)
		{
		 ...
		 public bool _Contains(long _plural)
		{
		 ...
		 public IEnumerable<long> SequenceUpTo_inLong__positive(long _positive)
		{
			if (_positive == 1)
			{
				return new long[0];
		 ...
		 public IEnumerable<long> SequenceUpTo_inLong(long _plural)
		{
			_PopulateAndCommit(_plural);
		 ...
		 public IEnumerable<long> SequenceUpToMax()
		{
		 ...
		 public Tuple<long, long, bool> GetUpperPrimability1()
		{
		 ...
		 public Tuple<long, long, bool> GetUpperPrimability_noNullReturned()
		{
			var maxRec = GetMaxRecord_byCheckNull();
			if (maxRec == null)
			{
		 ...
		 public db.Prime GetMaxRecord_byCheckNull()
		{
		 ...
		 public db.sp_PrimeMaxRecord_Result GetMaxRecord2()
		{
		 ...
		 public void PopulateToCover(long plural)
		{
		 ...
		 public void _PopulateSomeMore_tableAlreadyInited(int batchSize_positive=100,int totalBatches_positive=10){
		 ...
		 public long _PopulateSomeMore2_initialized(int batchSize_positive)
		{
			long maxPrime;
			long maxSn;
			lock (db)
		 ...
		 private void _PopulateToCover(long currentPrimeSn, long currentBound, long newBound)
		{
		 ...
		 private void _PopulateToCover_saveByBatch(long currentPrimeSn, long currentBound, long newBound)
		{
			//long sn = 0;
